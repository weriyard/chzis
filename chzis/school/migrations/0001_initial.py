    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modification', models.DateTimeField(default=datetime.datetime(2015, 12, 30, 15, 22, 25, 353553))),
            ],
            options={
                'ordering': ['number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modification', models.DateTimeField(default=datetime.datetime(2015, 12, 30, 15, 22, 25, 352379))),
            ],
            options={
                'ordering': ['number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modification', models.DateTimeField(default=datetime.datetime(2015, 12, 30, 15, 22, 25, 354900))),
